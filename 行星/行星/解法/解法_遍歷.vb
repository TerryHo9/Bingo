...
Public Class 解法_遍歷 : Implements I計算最佳盤面
    Public Function 解法(局 As 一局) As Integer Implements I計算最佳盤面.解法
        Dim 索引1 As Byte, 索引2 As Byte
            ...
            For B As Byte = 0 To 3
                For C As Byte = 0 To 3
                    For D As Byte = 0 To 3
                        ...
                        For aa As Integer = 0 To 未亮燈.Count - 1 'worst case=22取2=231*2(因為有保送燈機制,先進哪顆會影響,因此要再X2才是遍歷)
                            For bb As Integer = aa + 1 To 未亮燈.Count - 1
                                索引1 = 未亮燈(aa) : 索引2 = 未亮燈(bb)
